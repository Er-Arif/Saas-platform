...
export default function BillingPage() {
  return (
    <Section
      ...
      description="India-first billing flows support Razorpay, UPI-aware checkouts, GST breakdowns, and recurring product renewals."
    >
      <div className="mb-6 grid gap-6 lg:grid-cols-3">
        ...
        <FeatureCard title="Subscription controls" description="Renewals, upgrade paths, expiry visibility, and dunning-ready lifecycle tracking." />
      </div>
